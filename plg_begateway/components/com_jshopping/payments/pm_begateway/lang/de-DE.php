...
define('_JSHOP_BEGATEWAY_SHOP_PUBLIC_KEY', 'Shop public key');
...
define('_JSHOP_BEGATEWAY_ENABLE_ERIP', 'Enable ERIP payments');
define('_JSHOP_BEGATEWAY_WIDGET_CSS', 'Widget CSS styles');
define('_JSHOP_BEGATEWAY_WIDGET_CSS_DESCRIPTION', '');
define('_JSHOP_BEGATEWAY_TRANSACTION_TYPE', 'Transaction type');
