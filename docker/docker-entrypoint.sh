...
if [ -d /var/www/html/components/com_jshopping ]; then
  ...
  ln -fs /plg_begateway/components/com_jshopping/lang/pm_begateway /var/www/html/components/com_jshopping/lang/pm_begateway
fi
